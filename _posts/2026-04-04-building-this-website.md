...
- **CV** — The basics
- **Personal** — GitHub repos and eventually more

## What's Next

A few things on the roadmap:

- More blog posts — agentic dev notes, memory research, movie takes
...
This entire site was set up in a single session with an AI coding assistant. Every config edit, every page, every commit — pair-programmed with Claude. The "Movie Guy" energy is real: I directed, it typed.
